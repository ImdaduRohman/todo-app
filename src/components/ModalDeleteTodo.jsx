...
import { deleteTodo, getDetailTodo } from '../lib/todo';
...
export default function ModalDeleteTodo({
  ...
  const {
    isLoading,
    data: detailTodo,
  } = useQuery(['detailTodo', idActivity], () => getDetailTodo(idActivity));
      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel data-cy='modal-delete' className="w-full max-w-md flex flex-col p-8 pb-6 gap-10 overflow-hidden rounded-xl bg-white text-left align-middle shadow-xl transition-all">
